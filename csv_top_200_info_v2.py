...
# def player_milti_search_options(player_list):
...
def multi_search(player_name):
    # player_1 = None
    # player_2 = None
    # player_3 = None
    results = get_close_matches(player_name, available_player_list, n=10, cutoff=0.36)
    print ('Top {} Matches {}'.format(len(results), results))
    # for result in results:
    #     # print (result)
    #     player_1 = results[0]
    #     player_2 = results[1]
    #     player_3 = results[2]
    # print ('1_{}'.format(player_1))
    # print ('2_{}'.format(player_2))
    # print ('3_{}'.format(player_3))
    # if len(results) == 1:
    #     print ('Top {} Matche \n 1_{}'.format(len(results),player_1))
    # if len(results) == 2:
    #     print ('Top {} Matches \n 1_{} 2_{}'.format(len(results),player_1, player_2))
    # if len(results) == 3:
    #     print ('Top {} Matches \n 1_{} 2_{} 3_{}'.format(len(results),player_1, player_2, player_3))
